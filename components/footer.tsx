      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Théâtre Plus</span>
            </div>
            <p className="text-primary-foreground/80 text-sm mb-4">
              Votre plateforme de réservation en ligne pour les plus beaux spectacles de théâtre en France.
            </p>
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary-foreground/60 text-sm">© 2025 Théâtre Plus. Tous droits réservés.</p>
