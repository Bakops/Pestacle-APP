    ...
    return (
        <section className="relative h-[85vh] min-h-[600px] overflow-hidden bg-black">
            <div className="absolute inset-0">
                <img
                    src="/Catedrale.png"
                    alt="Jeux et Lumière à la Cathédrale"
            ...
            <span className="text-xs font-semibold uppercase tracking-wide text-accent-foreground">
              Spectacle vedette
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 leading-tight">
                        Jeux et Lumière à la Cathédrale
                    </h1>
                    <p className="text-lg text-white/90 mb-8 leading-relaxed">
                        Un spectacle visuel époustouflant qui illumine la cathédrale avec des jeux de lumière et des couleurs magiques.
                    </p>
