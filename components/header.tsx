                            ...
                            <div className="relative w-full max-w-3xl mx-auto">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-15 pl-16 pr-16 py-4 text-lg bg-white rounded-3xl shadow-2xl focus:outline-none focus:ring-4 focus:ring-[#FF6B6B]/30 text-gray-900 placeholder:text-gray-400"
                                    />
                                    {searchQuery && (
                                        <button
                                            onClick={clearSearch}
